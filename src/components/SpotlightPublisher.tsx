      ...
      <div className="bg-white border border-zinc-200/90 rounded-[2.2rem] p-6 sm:p-8 space-y-6 shadow-xs text-center">
        ...
        <div className="space-y-2 max-w-md mx-auto">
          ...
          <p className="text-xs sm:text-sm font-semibold text-zinc-500 leading-relaxed">
            Vous n'avez pas encore l'autorisation de publier des vidéos sur la plateforme. Pour avoir le droit de publier, veuillez contacter l'équipe TrocShop au numéro WhatsApp ci-dessous.
          </p>
        </div>
        ...
        <div className="pt-2">
          ...
          >
            ...
            <span>Contacter l'équipe TrocShop (01 60 23 21 64)</span>
          </a>
        </div>
      </div>
    );
