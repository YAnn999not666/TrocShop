                 ...
                 <div className="flex items-center gap-4 bg-white/95 p-4 rounded-2xl shadow-sm border border-zinc-100 relative mt-2 text-zinc-900">
                    {exchangeProduct && (
                      <div className="flex-1 flex flex-col items-center text-center gap-1 min-w-0">
                        ...
                        <img src={exchangeProduct.images[0]} className="w-20 h-20 rounded-xl object-cover shadow-md border border-zinc-100" alt={exchangeProduct.title} />
                        <p className="text-[10px] font-bold text-zinc-900 truncate w-full mt-1">{exchangeProduct.title}</p>
                      </div>
                    )}
                    <div className="flex flex-col items-center gap-1 text-orange-600/50">
                    ...
                    {targetProduct && (
                      <div className="flex-1 flex flex-col items-center text-center gap-1 min-w-0">
                        <span className="text-[6px] font-black text-zinc-600 uppercase tracking-[0.2em] mb-1">DEMANDE</span>
                        <img src={targetProduct.images[0]} className="w-20 h-20 rounded-xl object-cover shadow-md border border-zinc-100" alt={targetProduct.title} />
                        <p className="text-[10px] font-bold text-zinc-900 truncate w-full mt-1">{targetProduct.title}</p>
                      </div>
                    )}
                  </div>
              </div>
...
export function ChatWindow({ 
  ...
  return (
    ...
    >
      <header className="fixed top-0 left-0 right-0 z-50 p-4 pt-safe pb-2 bg-transparent pointer-events-none">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-1.5 font-sans">
                    ...
                    {(() => {
                      const isOtherCertified = (otherProfile?.is_certified as any) === true || (otherProfile?.is_certified as any) === 'vrai' || (otherProfile?.isCertified as any) === true || (otherProfile?.isCertified as any) === 'vrai' || (otherProfile?.['is certified'] as any) === true || (otherProfile?.['is certified'] as any) === 'vrai' || otherProfile?.isPro === true || otherProfile?.is_pro === true;
