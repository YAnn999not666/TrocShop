...
export function ChatWindow({ 
  ...
  return (
    <motion.div 
      ...
      className="fixed md:absolute inset-0 z-[200] bg-zinc-50 flex flex-col overflow-hidden h-[100dvh] md:h-full"
    >
      ...
      <div className="flex-1 overflow-hidden relative flex flex-col bg-transparent">
        ...
        <div ref={scrollRef} className={cn(
          "flex-1 overflow-y-auto overscroll-contain px-4 pb-32 space-y-4 no-scrollbar relative z-10 transition-all duration-300",
        ...
        {/* Input Area */}
        <div className="sticky bottom-0 flex-none p-4 bg-white border-t border-zinc-100 z-50">
          <AnimatePresence>
            {isRecording && (
              <motion.div 
