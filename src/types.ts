...
export type ProductStatus = "available" | "pending" | "sold" | "reserved" | "out_of_stock" | "paused" | "expired";
...
export interface UserProfile {
  ...
  isVerified?: boolean;
  isCertified?: boolean;
  is_certified?: boolean | string;
  'is certified'?: boolean | string;
  notificationsEnabled?: boolean;
  badges?: string[];
  isOnline?: boolean;
  isStudent?: boolean;
  studentSchool?: string;
  is_partener?: boolean | string;
...
export interface ServiceListing {
  id: string;
  serviceType: 'car' | 'house';
  title: string;
  price: number;
  pricePeriod: 'day' | 'month'; // 'jour' / 'mois'
  neighborhood: string;
