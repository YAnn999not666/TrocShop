...
function SellScreen({
  ...
  useEffect(() => {
    // Search for profile to prefill neighborhood and check is_pro status
              ...
              <div className="fixed md:absolute inset-0 bg-black/95 z-[999] flex flex-col justify-between p-6">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    type="button"
                    onClick={stopCamera}
                    className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-white active:scale-95 font-bold"
                  >
                    ✕
                  </button>
                </div>
            ...
            {imagePreviews.length > 0 && (
              <div className="flex gap-3 overflow-x-auto no-scrollbar py-2 px-1">
                {imagePreviews.map((p, i) => (
                  <div
                    key={i}
                    className="aspect-square h-24 w-24 shrink-0 relative rounded-xl overflow-hidden border-2 border-white group shadow-sm transition-all hover:scale-105 active:scale-95"
                  >
                    <img
                      src={p}
                      className="w-full h-full object-cover"
