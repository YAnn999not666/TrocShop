...
export default function App() {
  ...
  const [profileView, setProfileView] = useState<
    "main" | "listings" | "favorites" | "settings" | "security"
  >("main");
              ...
              >
                {!user ? (
                    ...
                    <div className="bg-white rounded-[2.5rem] border border-zinc-100 shadow-xl shadow-zinc-200/50 overflow-hidden space-y-6">
                      ...
                      <div className="px-8 pb-8 -mt-14 relative z-10 space-y-6">
                        <div className="flex items-end justify-between">
                          ...
                          <div className="flex gap-2">
                            <div
                              className="flex flex-col items-center px-4 py-2 bg-zinc-50 rounded-2xl cursor-pointer"
                    ...
                    <div className="bg-white p-6 rounded-[2.5rem] border border-zinc-100 shadow-xl shadow-zinc-200/40 space-y-6 text-zinc-800">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="flex gap-2.5 items-start">
                              ...
                              <div>
                                ...
                                secrets secrets Mobile Money ou vos coordonnées
                                de carte bancaire dans la messagerie. L'équipe
                                TrocShop ne vous demandera jamais un code
                                confidentiel.
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="space-y-4 border-t border-zinc-150 pt-5">
                        ...
                        <div className="pl-8 space-y-3 text-xs text-zinc-650 leading-relaxed">
                          <p className="font-semibold">
                            Certaines grandes entreprises de confiance basées à
                            Abidjan publient leurs offres sur TrocShop. Elles
                            sont les seules autorisées à déroger à la règle :
                          </p>
                          ...
                          <div className="space-y-3">
                            <p>
                              ...
                              Ces partenaires officiels certifiés sont
                              directement identifiables grâce à un badge en
                              forme de bouclier vert affiché sur leur profil et
                              leurs produits.
                            </p>

                            <p>
                              <strong className="text-zinc-900 font-extrabold uppercase text-[10px] tracking-wider block mb-0.5">
                                Le paiement à l'avance autorisé
                              </strong>
                              L'équipe TrocShop a contrôlé de manière rigoureuse
                              l'identité, l'adresse physique et la moralité
                              professionnelle de ces entreprises. Vous pouvez
                              leur payer à l'avance par Mobile Money en toute
                              sécurité.
                            </p>

                            <p>
                              <strong className="text-zinc-900 font-extrabold uppercase text-[10px] tracking-wider block mb-0.5 font-sans">
                                Livraison gratuite assurée
                              </strong>
                              TrocShop gère personnellement et gratuitement le
                              transport de l'article depuis Abidjan jusqu'à
                              votre point de retrait à Yamoussoukro, assurant
                              ainsi une livraison 100 % garantie.
                            </p>
                          </div>
                          ...
                          <div className="bg-red-50 border border-red-100 p-4 rounded-2xl flex items-start gap-2.5 mt-4">
                            ...
                            <p className="text-[11px] text-red-800 font-bold leading-normal">
                              Attention : Si un vendeur classique n'ayant pas le
                              badge de bouclier vert 🛡️ sur son profil vous
                              demande quoi que ce soit d'autre qu'une remise en
                              main propre, refusez immédiatement et signalez-le
                              à l'équipe. Tout compte coupable de tentative de
                              fraude sera banni définitivement.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {profileView === "listings" && (
                      <div className="flex bg-zinc-100 p-1 rounded-[1.2rem] max-w-xs">
                        <button
                          onClick={() => setListingsTab("products")}
                          className={cn(
                            "flex-1 py-3 px-4 rounded-[1rem] text-[10px] font-black uppercase tracking-widest transition-all",
                            listingsTab === "products"
                        ...
                        <button
                          onClick={() => setListingsTab("services")}
                          className={cn(
                            "flex-1 py-3 px-4 rounded-[1rem] text-[10px] font-black uppercase tracking-widest transition-all",
                        ...
                        >
                          Services (
                          {
                            allServices.filter((s) => s.sellerId === user?.uid)
                              .length
                          }
                          )
                        </button>
                    ...
                    <div className="grid grid-cols-2 min-[980px]:grid-cols-3 min-[1440px]:grid-cols-4 gap-4">
                      {profileView === "listings"
                        ? listingsTab === "products"
                          ...
                          : allServices
                              .filter((s) => s.sellerId === user?.uid)
                              .map((s) => (
                                <div
                                  key={s.id}
                                  className="relative group bg-white rounded-3xl border border-zinc-150 overflow-hidden shadow-sm flex flex-col h-full cursor-pointer"
                                  onClick={() => {
                                    // Open services tab and select the service
                                    setActiveTab("services");
                                    // We will emit an event or state change to trigger service details view in ServicesPage.tsx
            ...
            >
              <div className="max-w-xl mx-auto px-6 py-12 pb-32">
                ...
                <div className="flex flex-col items-center text-center space-y-6 mb-12">
                  ...
                  <div className="flex pt-3 justify-center w-full">
                    <Button
                      onClick={async () => {
                      ...
                      className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-[1.5rem] px-8 py-3.5 text-[10px] uppercase font-black tracking-[0.15em] flex items-center gap-2.5 active:scale-95 transition-all cursor-pointer shadow-lg shadow-orange-500/15 hover:shadow-orange-500/25 border-none min-w-[200px] justify-center"
                    >
                          ...
                          <div className="space-y-1.5">
                            ...
                            <CustomDropdown
                              ...
                              options={[
                                ...
                                { value: "all", label: "--- Articles seulement ---" },
                                ...CATEGORIES.map((cat) => ({
                                  value: cat,
                                  label: cat,
                                })),
                ...
                {(() => {
                  ...
                  const showServicesTab =
                    isPublicProfilePro || filteredServices.length > 0;
                    ...
                    <div className="flex gap-2.5 items-start">
                      ...
                      <p className="font-semibold">
                        <strong className="text-zinc-900 font-extrabold">
                          Zéro dépôt à l'avance
                        </strong>{" "}
                        (sauf pour nos Fournisseurs Directs d'Abidjan).
                      </p>
                    </div>
...
function ProductSheet({
  ...
  return (
    <>
      ...
      >
        <div
          className="w-full h-full md:max-w-xl md:h-[90vh] md:rounded-[3rem] md:shadow-2xl md:border md:border-zinc-100/50 bg-white rounded-t-[3rem] overflow-hidden flex flex-col relative"
          onClick={(e) => e.stopPropagation()}
        >
          {/* Carousel Section */}
          <div className="w-full h-[50vh] md:h-[520px] bg-zinc-50 relative group flex flex-col shrink-0 overflow-hidden">
                ...
                {product.images.map((img, i) => (
                  ...
                  >
                    <motion.div
                      ...
                      className="w-full h-full relative cursor-zoom-in group/img shadow-[0_48px_96px_-24px_rgba(0,0,0,0.12)] rounded-[2.5rem] md:rounded-[2.5rem] overflow-hidden bg-zinc-50 border border-zinc-100"
                ...
                <>
                  ...
                  <div className="absolute top-1/2 -translate-y-1/2 left-8 right-8 flex justify-between pointer-events-none opacity-0 group-hover:opacity-100 transition-all duration-700 z-30">
                    ...
                    <button
                      onClick={() =>
                        setCurrentImg(
                          Math.min(product.images.length - 1, currentImg + 1),
                        )
                      }
                      className={cn(
                        "w-16 h-16 rounded-[2rem] bg-white/95 backdrop-blur-2xl border border-zinc-100 text-zinc-900 flex items-center justify-center pointer-events-auto transition-all active:scale-75 hover:bg-zinc-900 hover:text-white shadow-[0_16px_32px_-8px_rgba(0,0,0,0.1)] hover:shadow-orange-600/20",
              ...
              >
                <div
                  className={cn(
                    ...
                    isSellerPartner
                      ? "bg-emerald-600 text-white shadow-emerald-650/15"
                      : "bg-red-600 text-white shadow-red-650/15",
                  )}
                >
                  <Shield
                    size={18}
                  ...
                  {isSellerPartner ? (
                    <>
                      ...
                      <p className="text-[11px] text-emerald-850 font-bold leading-relaxed mt-1">
                        Pour ce partenaire de confiance basé à Abidjan, le
                        paiement à l'avance est exceptionnellement autorisé. La
                        livraison de vos trocs et achats est gérée et garantie
                        gratuitement par TrocShop.
                      </p>
                    </>
                  ) : (
                    <>
                      ...
                      <p className="text-[11px] text-red-850 font-extrabold leading-relaxed mt-1">
                        Ce vendeur n'a pas le badge bouclier 🛡️. Refusez tout
                        paiement ou dépôt à l'avance sous n'importe quel
                        prétexte. La transaction et le paiement doivent
                        s'effectuer uniquement lors de la rencontre physique en
                        public.
                      </p>
                    </>
                  )}
                  ...
                  */}
                      ...
                      <button
                        onClick={() => {
                          const productUrl = `${window.location.origin}/?product=${product.id}`;
                          const msg = encodeURIComponent(
                            `Découvre l'article "${product.title}" sur TrocShop ! Regarde ici : ${productUrl}`,
                          );
                          window.open(
                        ...
                        className="h-14 w-14 rounded-2xl bg-emerald-50 text-emerald-600 hover:bg-emerald-100 flex items-center justify-center active:scale-95 transition-all border border-emerald-100 shadow-sm shrink-0"
