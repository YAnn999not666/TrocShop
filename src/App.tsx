  ...
  return (
    <div className="min-h-screen w-full bg-white antialiased">
      ...
      <header className={cn(
        ...
        (activeTab === 'shoplight' || activeTab === 'messages' || activeTab === 'student' || activeTab === 'troc' || activeTab === 'category' || selectedSellerId || selectedProduct) ? "hidden" : ""
      )}>
      ...
      <main className={cn(
        activeTab === 'shoplight'
          ? "w-full h-screen fixed inset-0 z-50 bg-black overflow-hidden min-[980px]:ml-[220px] min-[980px]:w-[calc(100%-220px)]"
