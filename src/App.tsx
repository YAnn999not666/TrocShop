  ...
  return (
    <div className="min-h-screen w-full bg-white antialiased">
      <div className="w-full min-h-screen min-[980px]:h-screen min-[980px]:overflow-hidden bg-white text-zinc-900 font-sans selection:bg-orange-100 selection:text-orange-900 relative flex flex-col overflow-x-hidden min-[980px]:flex-row min-[980px]:bg-white">
        ...
        <header
          className={cn(
            "fixed top-4 left-4 right-4 z-[1000] bg-white/40 backdrop-blur-[40px] backdrop-saturate-[180%] border border-white/50 rounded-[2rem] px-6 h-20 flex flex-col justify-center shadow-[0_20px_50px_rgba(0,0,0,0.05)] min-[980px]:fixed min-[980px]:top-0 min-[980px]:left-[220px] min-[980px]:right-0 min-[980px]:w-[calc(100%-220px)] min-[980px]:rounded-none min-[980px]:border-0 min-[980px]:border-b min-[980px]:border-zinc-200/80 min-[980px]:shadow-none min-[980px]:bg-white min-[980px]:px-8",
            activeTab === "shoplight" ||
              activeTab === "student" ||
              activeTab === "troc" ||
              activeTab === "category" ||
          ...
          className={cn(
            activeTab === "shoplight"
              ...
              : activeTab === "student" ||
                  ...
                  activeTab === "category" ||
                  activeTab === "services"
                ? "pt-6 min-[980px]:pt-6 pb-36 px-6 max-w-lg mx-auto w-full h-auto md:h-full md:overflow-y-auto no-scrollbar relative transition-all duration-300 min-[980px]:max-w-none min-[980px]:mx-0 min-[980px]:ml-[220px] min-[980px]:w-[calc(100%-220px)] min-[980px]:px-12 min-[980px]:pb-12"
                : "pt-28 min-[980px]:pt-24 pb-36 px-6 max-w-lg mx-auto w-full h-auto md:h-full md:overflow-y-auto no-scrollbar relative transition-all duration-300 min-[980px]:max-w-none min-[980px]:mx-0 min-[980px]:ml-[220px] min-[980px]:w-[calc(100%-220px)] min-[980px]:px-12 min-[980px]:pb-12",
          )}
        >
        ...
        {activeTab !== "auth" && (
          <nav
            className={cn(
              "fixed md:absolute bottom-[calc(1.5rem+env(safe-area-inset-bottom,16px))] md:bottom-6 left-6 right-6 z-[100] h-20 transition-all duration-300 min-[980px]:hidden",
              activeConversationId ||
                isNavHidden ||
                activeTab === "notifications" ||
                activeTab === "shoplight"
