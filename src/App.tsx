...
export default function App() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      debugDiv.style.cssText = 'position:fixed;top:0;left:0;right:0;background:red;color:white;padding:10px;z-index:99999;font-size:14px;word-break:break-all;';
      debugDiv.textContent = 'DEBUG URL: ' + window.location.href;
  ...
  const handleContactSellerFromSpotlight = async (
    ...
    const messageText = `Bonjour, je suis intéressé(e) par votre article vu sur TrocShop Spotlight : "${descriptionText}". Est-il toujours disponible ?`;
