...
const PublicSpotlightPlayer = ({ item }: { item: any }) => {
    ...
    <div className="bg-zinc-50 border border-zinc-150 rounded-[2.5rem] p-6 space-y-4 max-w-sm mx-auto shadow-sm">
      ...
      >
        ...
        <div className="absolute inset-0 p-4 flex flex-col justify-between">
          ...
          {/* Description overlay */}
          <div className="z-10 mt-auto text-white pointer-events-none space-y-1">
...
export default function App() {
  ...
  const loadExplorerPage = (pageIndex: number, lastDocOption: any) => {
    ...
    const unsub = onSnapshot(
      ...
      (err) => {
        console.warn(
          "Error subscribing to explorer products:",
          err?.message || err,
        );
        setExplorerLoading(false);
    ...
    try {
      ...
      if (!snap.exists()) {
        ...
        batch.set(convRef, {
          ...
          productImage: "",
          productPrice: 0,
          lastMessage: `Intéressé par votre Spotlight`,
    ...
    try {
      ...
      if (!snap.exists()) {
        ...
        batch.set(convRef, {
          ...
          sellerId: sellerId,
          lastMessage: `Intéressé par votre service`,
          lastSenderId: user.uid,
          unreadUserId: sellerId,
          ...updateData,
        });
        ...
        // Force update the product details to repair/prevent any 'undefined' or stale data in existing threads!
  ...
  const handleProposeExchange = async (
    ...
    try {
      ...
      let barterMsg = `Bonjour ! Je vous propose un troc pour votre article "${targetProduct.title}". Je vous propose en échange mon/mes article(s) : "${exchangeTitles}"`;
      if (priceAdjustment !== 0) {
        barterMsg += ` avec un ajustement de ${priceAdjustment.toLocaleString()} FCFA`;
      }
      barterMsg += `.`;
                        ...
                        <div className="space-y-8 animate-fadeIn">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 justify-center">
                            {publicSpotlights.map((item) => (
                              ...
                              >
                                <PublicSpotlightPlayer item={item} />
                              </div>
                            ))}
                          </div>
                        </div>
              ...
              <div className="p-8 bg-zinc-900 rounded-[2.5rem] text-white flex flex-col gap-6 shadow-xl">
                ...
                >
                  ...
                  <Button
                    ...
                    variant="ghost"
                    className="border border-white/20 rounded-full px-6 text-[10px] uppercase font-black tracking-widest text-white hover:bg-white/10"
                  >
                    Voir le profil
                  </Button>
                </div>
